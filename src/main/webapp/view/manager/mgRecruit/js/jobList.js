			...
			if(rst && rst.total>0){
				$.each(rst.data,function(i, v){
					ddHtml = '<dd>'
						...
						+ '<div class="t_c info5_4 title" style="text-align:center;float:left; width:8%;height:40px;">' +v.jobTypeName+ '</div>'
						+ '<div class="t_c info5_4 title" style="text-align:center;float:left; width:10%;height:40px;">' +v.cityName+ '</div>'
						...
						+ '<div class="t_c info5_4 title" style="text-align:center;float:left; width:8%;height:40px;"><a class="resume" href="javascript:;"onclick="resumeList('+v.id+');">11</a></div>'
						...
						+ '<li style="float:left; width:26px;"><a class="del" href="javascript:;"onclick="del(this);">修改</a></li>'
